...
const HomePage = () => {
  ...
  <section className="flex flex-col items-center justify-center h-full px-4 py-12 text-center bg-green-100">
    ...
    />
    <Link to='/shop'>
    <button className="block px-6 py-3 text-white bg-green-600 rounded-full hover:bg-green-800" >
      Explore Plants
